...
public class DrawerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nev_study) {
            Intent intent_study = new Intent(getApplicationContext(), MainActivity.class);
            ...
            Intent intent_community = new Intent(getApplicationContext(), CommunityMainActivity.class);
